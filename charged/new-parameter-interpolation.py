...
fits_0 = np.genfromtxt("/home/batman/Downloads/blackhawk_v2.3/src/tables/gamma_tables/charged/spin_0_fits.txt", skip_header=1)
fits_1 = np.genfromtxt("/home/batman/Downloads/blackhawk_v2.3/src/tables/gamma_tables/charged/spin_1_fits.txt", skip_header=1)
fits_2 = np.genfromtxt("/home/batman/Downloads/blackhawk_v2.3/src/tables/gamma_tables/charged/spin_2_fits.txt", skip_header=1)
fits_12 = np.genfromtxt("/home/batman/Downloads/blackhawk_v2.3/src/tables/gamma_tables/charged/spin_0.5_fits.txt", skip_header=1)    
...
def integrand(E, M, Q):
    ...
    return (term0 + 27*term1 + 2*term2 + 90*term12)*E/(2*np.pi)
...
np.savetxt("/home/batman/Downloads/blackhawk_v2.3/scripts/greybody_scripts/greybody_factors/charged/new_alpha_charged.txt", results)
print("Done")
