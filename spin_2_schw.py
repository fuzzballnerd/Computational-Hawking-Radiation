...
def V1(r, M, l):
    return nu_2(l)*G(r, M)/H(r) + 2*F(r, M)**2/r**2 - F(r, M)*dF_dr(r, M)/r
...
file1 = open("/home/sarthaka/Downloads/blackhawk_v2.3/scripts/greybody_scripts/greybody_factors/fM_schw_2_high_py.txt", "w")
        ...
        for i in range(nbmodes):
            ...
            for m in range(-l[i], l[i]+1):
                ...
                if m>-l[i]:
                    ...
                    s0[k][j][i][m+l[i]] = solver(M, omega[j], l[i])
