...
def V0(r, M, l):
    return nu_0(l)*G(r, M)/H(r) + F(r, M)*dF_dr(r, M)/r 
...
file1 = open("/home/sarthaka/Downloads/blackhawk_v2.3/scripts/greybody_scripts/greybody_factors/fM_schw_0_low_py.txt", "w")
